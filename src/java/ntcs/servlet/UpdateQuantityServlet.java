    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (cart != null) {
                ...
                for (RequestResourceDTO requestResourceDTO : items.keySet()) {
                    if (requestResourceDTO.getIdResource().equalsIgnoreCase(idResource) && requestResourceDTO.getRentalDate().equals(rentalDate)) {
                        items.replace(requestResourceDTO, newQuantity);
                    }
                }
            }
            ...
            response.sendRedirect(VIEW_REQUEST_PAGE);
        }
    }
